...
<c:if test="${checkLogin == 'true'}">
    <form action="/controller" method="post">
        ...
        <p align="center">Номер паспорта: <input name="passport" type="text" required></p>
        <p align="center">Имя: <input type="text" name="name" required></p>
        <p align="center">Фамилия: <input type="text" name="surname" required></p>
        <p align="center">Телефон: <input type="text" name="telephone"></p>
